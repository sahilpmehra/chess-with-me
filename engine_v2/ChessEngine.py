# engine_v2.py/ChessEngine.py
'''
This is the second version of the chess engine.
It uses PIECE SQUARE TABLES along with a minimax algorithm with alpha-beta pruning to find the best move.
'''
import chess
